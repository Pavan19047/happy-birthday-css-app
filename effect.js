...
$('document').ready(function () {
  ...
  $('#play').click(function () {
    var videoContainer = $(
      '<div class="video-container"><video src="video.mp4" autoplay></video></div>'
    )
    $('body').append(videoContainer)
    videoContainer.show().css('animation', 'zoomIn 1s forwards')
    ...
    function msgLoop (i) {
      $('p:nth-child(' + i + ')')
        ...
        .done(function () {
          ...
          $('p:nth-child(' + i + ')')
            .fadeIn('slow')
            .delay(i === 2 ? 30000 : 1000) // Display the second paragraph for 30 sec
          if (i == 50) {
            $('p:nth-child(49)')
              .fadeOut('slow')
              .promise()
